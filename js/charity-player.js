    ...
    "use strict";
        ...
        var pluginName = "musicPlayer",
            defaults = {
                ...
                infoElements: ['title' , 'date' , 'artist'] ,
        ...
        $.extend( Plugin.prototype, {
            init: function() {
                ...
                for( var elemItem in this.settings.elements )
                {
                    ...
                    if (this.settings.elements[elemItem] == "volume" ) {
                        ...
                        volumeElem   = "<div class='volume'><div class='volume-btn' title='Volume'></div><div class=' volume-adjust'><div><div></div></div></div></div></div>" ;
                    ...
                    //PREPARE ARTWORK
                       ...
                       artworkElem = "<div class='left-side'><div class='cover'></div>";
                    ...
                    //PREPARE INFORMATION displayed by the player in  the given order
                        ...
                        $.inArray("date", this.settings.infoElements ) != '-1'  ? dateElem    = "<div class='date'></div>" : dateElem = " " ;
                        ...
                        for( var item in this.settings.infoElements ) {
                            ...
                            else if ( this.settings.infoElements[item]  == "date" ) {   infoInnerElem += dateElem ;  }
                            else if ( this.settings.infoElements[item]  == "artist" ) {   infoInnerElem += artistElem ;  }
                        }
                        infoElem = "<div class='info' >" + infoInnerElem + "</div></div>";
                    ...
                    //PREPARE CONTROLS inner elements to display [play, stop, forward or backward] in the given order
                        ...
                        $.inArray("backward", this.settings.controlElements) != '-1'  ? backwardElem   = "<div class='rew'><i class='icofont icofont-ui-previous'></i></div>"      : backwardElem  = " " ;
                        $.inArray("forward", this.settings.controlElements)  != '-1'  ? forwardElem    = "<div class='fwd'><i class='icofont icofont-ui-next'></i></div>"        : forwardElem   = " " ;
                        $.inArray("stop", this.settings.controlElements) != '-1'      ? stopElem       = "<div class='stop'><i class='icofont icofont-ui-play-stop'></i></div>"       : stopElem      = " " ;
                        $.inArray("play", this.settings.controlElements) != '-1'      ? playElem       = "<div class='play'><i class='icofont icofont-ui-play'></i></div><div class='pause'><i class='icofont icofont-ui-pause'></i></div>" : playElem  = " " ;
                        ...
                        controlElem   = "<div class='right-side'><div class='controls'>" + controlInnerElem + "</div>";
            ...
            initAudio: function(elem)
            {
                ...
                //Set the date name on the player
                $(this.trackInfo).children('.date').text(date);
